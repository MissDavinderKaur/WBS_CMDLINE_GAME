...
function translate(phrase) {
    ...
    // Iterate over the Array and translate each word
        const translatedWords = phraseArray.map(word => {
            ...
            if (vowels.includes(firstTwoChars[0]) && vowels.includes(firstTwoChars[1])) {
                return word + 'way';
            } else if (consonants.includes(firstTwoChars[0]) && consonants.includes(firstTwoChars[1])) { 
                // If a word starts with two consonants move the two consonants to the end of the word and add "ay."
                return word.slice(2) + firstTwoChars + 'ay';
            } else if (consonants.includes(firstTwoChars[0]) && vowels.includes(firstTwoChars[1])) {
                // If a word starts with a consonant and a vowel, put the first letter of the word at the end of the word and add "ay."
                return word.slice(1) + firstTwoChars[0] + 'ay';
            }   
        });
